package com.example.actividad5.Views
...
import com.example.actividad5.Components.GameCard
import com.example.actividad5.ViewModels.GamesViewModel

fun AgeCheck(age: Int, classification: String): Boolean {
    return if (classification == "E") {
        true
